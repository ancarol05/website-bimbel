            ...
            <main class="content p-4">
                <div class="container-fluid p-0">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" class="p-2 mt-2">
                        <input type="text" value="<?= $sertifikat['no_sertifikat']; ?>" name="no_sertifikat"
                            placeholder="no_sertifikat" class="p-2 form-control mb-3" required>
                        <input type="date" value="<?= $sertifikat['tanggal_sertifikat']; ?>" name="tanggal_sertifikat"
                            placeholder="Tanggal Sertifikat" class="p-2 form-control mb-3" required>
                        <input type="text" value="<?= $sertifikat['nama_program']; ?>" name="nama_program"
                            placeholder="Nama Program" class="p-2 form-control mb-3" required>
                        <input type="file" value="<?= $sertifikat['file_sertifikat']; ?>" name="file_sertifikat"
