...
if (isset($_POST['daftar'])) {
    ...
    $res = mysqli_query($conn, "INSERT INTO user VALUES(NULL, '3', '$username','$password', 'Aktif')");
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        <div class="d-flex justify-content-between">
                            <a href="index.php" class="fs-1 mb-3 text-light btn btn-facebook"><strong>BIMBEL.ID</a>
                        </div>
                    </div>
