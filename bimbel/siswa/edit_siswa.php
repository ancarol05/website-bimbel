                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="" method="POST" class="p-2 mt-2">
                                        <input type="text" value="<?= $siswa['nama_lengkap'] ?>" name="nama_lengkap"
                                            placeholder="Nama Lengkap" class="p-2 form-control mb-3" required>
                                        ...
                                        <span class="text-dark">Tanggal Lahir</span><input type="date"
                                            value="<?= $siswa['tanggal_lahir'] ?>" name="tanggal_lahir"
                                        ...
                                        <input type="text" name="agama" placeholder="Agama"
                                            value="<?= $siswa['agama']; ?>" class="p-2 form-control mb-3" required>

                                        <input type="text" <?= $siswa['kewarganegaraan']; ?> name="kewarganegaraan"
                                            placeholder="Kewarganegaraan" class="p-2 form-control mb-3" required>

                                        <input type="text" value="<?= $siswa['nohp']; ?>" name="nohp"
                                            placeholder="No HP" class="p-2 form-control mb-3" required>

                                        <input type="email" value="<?= $siswa['email']; ?>" name="email"
                                            placeholder="Email" class="p-2 form-control mb-3" required>
                                        ...
                                        <input type="text" value="<?= $siswa['nama_sekolah_asal'] ?>"
                                            name="nama_sekolah_asal" placeholder="Nama Sekolah Asal"
                                            class="p-2 form-control mb-3" required>

                                        <input type="text" value="<?= $siswa['kota_sekolah_asal'] ?>"
                                            name="kota_sekolah_asal" placeholder="Kota Sekolah Asal"
                                            class="p-2 form-control mb-3" required>
