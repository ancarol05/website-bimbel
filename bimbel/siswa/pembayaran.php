...
$pembayaran = mysqli_query($conn, "SELECT * FROM pembayaran WHERE id_user = '$id_user'");
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <div class="m-2 d-flex justify-content-between">
                                        ...
                                        <a href="tambah_pembayaran.php" class="btn btn-primary"> + Tambah</a>
                                    </div>
                                    ...
                                    <div class="table-responsive card p-3">
                                        <table class="table table-stripped" style="text-align: center">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a target="_blank" href="../data/<?= $td['struk']; ?>" downdload="">
                                                        Download
                                                        Struk </a>
                                                </td>
                                                <td>
                                                    <?php if ($td['status'] != 'Disetujui') : ?>
                                                    <span class="fw-bold text-danger"><?= $td['status']; ?></span>
                                                    <?php else : ?>
