...
if (isset($_POST['tambah'])) {
    ...
    mysqli_query($conn, "INSERT INTO alamat_asal VALUES (
        NULL, '$id_user','$alamat','$prov_kab_kec','$kode_pos'
    )");

    echo "<script>
            alert('Berhasil isi data alamat asal!');
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between mb-3">
                                        <h2>Isi Data Alamat Asal Siswa</h2>
                                        <a href="data_siswa.php" class="btn btn-outline-danger">Kembali</a>
                                    </div>

                                    <form action="" method="POST" class="p-2 mt-2">
                                        <input type="text" name="alamat" placeholder="alamat" class="p-2 form-control mb-3" required>
                                        <input type="text" name="prov_kab_kec" placeholder="Prov/Kab/Kac" class="p-2 form-control mb-3" required>
                                        <input type="text" name="kode_pos" placeholder="Kode Pos" class="p-2 form-control mb-3" required>
