                        ...
                        <div class="col-12">
                            ...
                            <div class="container-fluid p-0">
                                ...
                                <form action="" method="POST" class="p-2 mt-2">
                                    <input value="<?= $tutor['nama'] ?>" type="text" name="nama" placeholder="Nama"
                                        class="p-2 form-control mb-3" required>

                                    <input value="<?= $tutor['nik'] ?>" type="text" name="nik" placeholder="NIK"
                                        class="p-2 form-control mb-3" required>

                                    <input value="<?= $tutor['tempat_lahir'] ?>" type="text" name="tempat_lahir"
                                        placeholder="Tempat Lahir" class="p-2 form-control mb-3" required>

                                    <span class="text-dark">Tanggal Lahir</span><input
                                        value="<?= $tutor['tanggal_lahir'] ?>" type="date" name="tanggal_lahir"
                                        class="p-2 form-control mb-3" required>
                                    ...
                                    <input value="<?= $tutor['agama'] ?>" type="text" name="agama" placeholder="Agama"
                                        class="p-2 form-control mb-3" required>

                                    <input value="<?= $tutor['kewarganegaraan'] ?>" type="text" name="kewarganegaraan"
                                        placeholder="Kewarganegaraan" class="p-2 form-control mb-3" required>

                                    <input value="<?= $tutor['nohp'] ?>" type="text" name="nohp" placeholder="No HP"
                                        class="p-2 form-control mb-3" required>

                                    <input value="<?= $tutor['email'] ?>" type="email" name="email" placeholder="Email"
                                        class="p-2 form-control mb-3" required>

                                    <input value="<?= $tutor['gelar'] ?>" type="text" name="gelar" placeholder="Gelar"
                                        class="p-2 form-control mb-3" required>

                                    <input value="<?= $tutor['pendidikan_terakhir'] ?>" type="text"
