...
if (isset($_POST['tambah'])) {
    ...
    mysqli_query($conn, "INSERT INTO sertifikat VALUES (
        NULL, '$id_user','$no_sertifikat','$tanggal_sertifikat','$nama_program','$file_sertifikat'
    )");

    echo "<script>
            alert('Berhasil Tambah data sertifikat!');
                        ...
                        <div class="col-12">
                            ...
                            <div class="container-fluid p-0">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data" class="p-2 mt-2">
                                    <input type="text" name="no_sertifikat" placeholder="no_sertifikat"
                                        class="p-2 form-control mb-3" required>
                                    <input type="date" name="tanggal_sertifikat" placeholder="Tanggal Sertifikat"
                                        class="p-2 form-control mb-3" required>
